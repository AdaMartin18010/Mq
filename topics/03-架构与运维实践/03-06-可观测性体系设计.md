...
- [3.6 可观测性体系设计](#36-可观测性体系设计)
  ...
  - [3.6.2 Kafka可观测性设计](#362-kafka可观测性设计)
    - [Metrics指标](#metrics指标-1)
    - [Logging日志](#logging日志-1)
    - [Tracing链路追踪](#tracing链路追踪-1)
  - [3.6.3 MQTT可观测性设计](#363-mqtt可观测性设计)
    - [Metrics指标](#metrics指标-2)
    - [Logging日志](#logging日志-2)
    - [Tracing链路追踪](#tracing链路追踪-2)
  - [3.6.4 NATS可观测性设计](#364-nats可观测性设计)
    - [Metrics指标](#metrics指标-3)
    - [Logging日志](#logging日志-3)
    - [Tracing链路追踪](#tracing链路追踪-3)
